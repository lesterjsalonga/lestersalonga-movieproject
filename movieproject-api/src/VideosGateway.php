...
{
    $sql = "INSERT INTO videos (movieId, userId, description, url, site, videoKey, videoType, official) 
            VALUES (:movieId, :userId, :description, :url, :site, :videoKey, :videoType, :official)";
    $res = $this->conn->prepare($sql);
    ...
    $res->bindValue(":description", $data["description"], PDO::PARAM_STR); // Changed from name to description
    ...
    public function update(array $current, array $new): int
    {
        ...
        $res->bindValue(":dateUpdated", $dateUpdated, PDO::PARAM_INT);
